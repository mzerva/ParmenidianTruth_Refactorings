...
public class ArrayPopulationForGraphMetrics extends MetricsReportEngine {
	
		public ArrayPopulationForGraphMetrics(String targetFolder, Metric_Enums metric,DiachronicGraphInterface diachronicGraph){
