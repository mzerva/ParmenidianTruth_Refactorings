...
public class ArrayPopulationForVertexMetrics extends MetricsReportEngine {
	
	public ArrayPopulationForVertexMetrics(String targetFolder, Metric_Enums metric,DiachronicGraphInterface diachronicGraph){
